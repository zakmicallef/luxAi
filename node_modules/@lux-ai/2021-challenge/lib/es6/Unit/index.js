import { MoveAction, TransferAction, SpawnCityAction, PillageAction, } from '../Actions';
import { Actionable } from '../Actionable';
import { Position } from '../GameMap/position';
export class Unit extends Actionable {
    constructor(x, y, type, team, configs, idcount) {
        super(configs);
        this.type = type;
        this.team = team;
        this.cargo = {
    ...
    spendFuelToSurvive() {
        ...
        const woodNeeded = Math.ceil(fuelNeeded / this.configs.parameters.RESOURCE_TO_FUEL_RATE.WOOD);
        ...
        const coalNeeded = Math.ceil(fuelNeeded / this.configs.parameters.RESOURCE_TO_FUEL_RATE.COAL);
        ...
        const uraniumNeeded = Math.ceil(fuelNeeded / this.configs.parameters.RESOURCE_TO_FUEL_RATE.URANIUM);
...
export class Cart extends Unit {
    constructor(x, y, team, configs, idcount) {
