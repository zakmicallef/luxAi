...
exports.getAgent = function (req, res, next) {
    var agent = req.data.match.agents[parseInt(req.params.agentID)];
    if (!agent) {
...
exports.pickAgent = function (agent) {
    var picked = utils_1.pick(agent, 'id', 'name', 'tournamentID', 'logkey', 'version', 'status');
    return picked;
};
 ...
 */
router.get('/:agentID/logs', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var agent, url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                agent = req.data.agent;
                if (!agent.logkey) return [3 /*break*/, 4];
                if (!req.data.dimension.hasStorage()) return [3 /*break*/, 2];
                return [4 /*yield*/, req.data.dimension.storagePlugin.getDownloadURL(agent.logkey)];
            case 1:
                url = _a.sent();
            ...
            case 4: return [2 /*return*/, next(new error.BadRequest("No agent logs found"))];
